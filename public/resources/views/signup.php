...
<head>
    ...
    <title>Money Table Signup</title>
...
<main class="form-signin w-100 m-auto">
    <form method="post" action="/register">
        <img class="mb-4" src="/resources/images/moneyIcon.svg" alt="" width="80" height="80">
        ...
        <?php endif;?>
        <div class="form-floating">
            <input name="confirmPassword" type="password" class="form-control" id="floatingConfirmPassword"
